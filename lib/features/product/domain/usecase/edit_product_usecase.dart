...
class EditProductUsecase implements Usecase<DataState<ProductEntityResponse>, ProductRequestEntity>{
  EditProductUsecase(ProductRepository repository);
  @override
  Future<DataState<ProductEntityResponse>> call({ProductRequestEntity? param}) async {
   return await sl<ProductRepository>().updateProduct(param!.id!, param);
  }
}